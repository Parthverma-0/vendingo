...
import { PARTNER_HERO } from "@/lib/partner-content";
import { em } from "@/lib/em";
import IrisButton from "../ui/IrisButton";

const titleWords = PARTNER_HERO.title.split(" ");
...
// Live-stat cards pinned to the machine panel — host framing of the investor cards.
const floatCards = [
  {
...
// Mirrors the investor Hero: word-by-word headline rise on load, gentle
// parallax on scroll — copy lifts, the machine panel sinks, everything fades.
    ...
    >
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-5 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
        ...
        >
          ...
          >
            <IrisButton href="/location-partner/apply" pulse>
              {PARTNER_HERO.primaryCta} →
            </IrisButton>
            <IrisButton href="#partner-share" variant="ghost">
              {PARTNER_HERO.secondaryCta}
            </IrisButton>
          </motion.div>
